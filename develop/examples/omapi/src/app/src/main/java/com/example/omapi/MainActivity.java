...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // this variant use Lambda
//        _service = new SEService(this.getApplicationContext(), this.getMainExecutor(), ()->{
//            performTest();
//        });

        _service = new SEService(this.getApplicationContext(), this.getMainExecutor(), this::performTest);
    }
